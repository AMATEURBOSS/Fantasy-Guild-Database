...
-- Before checkout: show artifact status
SELECT artifact_id, name, status 
FROM Artifact
WHERE artifact_id = 1;
...
-- After checkout: show artifact status
SELECT artifact_id, name, status 
FROM Artifact
WHERE artifact_id = 1;
...
-- Before update: show current XP
SELECT * FROM QuestParticipation;
...
-- After update: show new XP values
SELECT * FROM QuestParticipation;
