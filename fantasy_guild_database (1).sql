...
-- =========================================================
-- SAMPLE INSERT DATA FOR COMPLEX QUERIES
-- =========================================================
-- Q1

INSERT INTO Artifact (`name`, `category`, `rarity`, `condition`, `status`)
VALUES ('Crystal Staff', 'Weapon', 4, 'GOOD', 'AVAILABLE');

INSERT INTO ArtifactRequest (member_id, artifact_id, request_date)
VALUES (2, 2, '2025-01-20');

INSERT INTO ArtifactLoan (member_id, artifact_id, request_id, loan_date, due_date)
VALUES (2, 2, 2, '2025-01-21', '2025-01-25');

-- Q2

INSERT INTO Payment (member_id, amount, type, status)
VALUES
(1, 50, 'DEPOSIT', 'PAID'),
(2, 120, 'SERVICE_FEE', 'PAID'),
(3, 30, 'DEPOSIT', 'PAID');


-- Q3

-- More loans of artifact 1
INSERT INTO ArtifactLoan (member_id, artifact_id, loan_date, due_date)
VALUES
(1, 1, '2025-02-01', '2025-02-05'),
(2, 1, '2025-02-10', '2025-02-15');

-- Loan artifact 2 again
INSERT INTO ArtifactLoan (member_id, artifact_id, loan_date, due_date)
VALUES
(3, 2, '2025-02-03', '2025-02-06');


-- Q4

UPDATE Artifact SET status = 'AVAILABLE' WHERE artifact_id = 1;
